...
namespace CarminoJ
{
	...
	//
	//////////////////////////////////////////////////////////////////////////////
	PacketBuffer::PacketBuffer(int iSize)
	{
		m_iBufferSize = iSize;
		m_chpReadPos = m_chaBufferDefault;
		m_chpWritePos = m_chaBufferDefault;
	...
	// 연산자 오퍼레이터.
	/* ============================================================================= */
	PacketBuffer&	PacketBuffer::operator = (PacketBuffer &clSrcAyaPacket)
	{
	...
	// 넣기.	각 변수 타입마다 모두 만듬.
	//////////////////////////////////////////////////////////////////////////
	PacketBuffer&	PacketBuffer::operator << (BYTE byValue)
	{
		Enqueue((char*)&byValue, sizeof(BYTE));
		return *this;
	}
	PacketBuffer&	PacketBuffer::operator << (char chValue)
	{
		Enqueue(&chValue, sizeof(char));
		return *this;
	}

	PacketBuffer&	PacketBuffer::operator << (short shValue)
	{
		Enqueue((char*)&shValue, sizeof(short));
		return *this;
	}
	PacketBuffer&	PacketBuffer::operator << (WORD wValue)
	{
		Enqueue((char*)&wValue, sizeof(WORD));
		return *this;
	}

	PacketBuffer&	PacketBuffer::operator << (int iValue)
	{
		Enqueue((char*)&iValue, sizeof(int));
		return *this;
	}
	PacketBuffer&	PacketBuffer::operator << (DWORD dwValue)
	{
		Enqueue((char*)&dwValue, sizeof(DWORD));
		return *this;
	}
	PacketBuffer&	PacketBuffer::operator << (float fValue)
	{
		Enqueue((char*)&fValue, sizeof(float));
		return *this;
	}

	PacketBuffer&	PacketBuffer::operator << (__int64 iValue)
	{
		Enqueue((char*)&iValue, sizeof(__int64));
		return *this;
	}
	PacketBuffer&	PacketBuffer::operator << (double dValue)
	{
	...
	// Return: (int)복사한 사이즈.
	//////////////////////////////////////////////////////////////////////////
	int		PacketBuffer::Enqueue(char *chpDest, int iSize)
	{
		////////////////////////////////	예외처리...
	...
	// Return: (int)복사한 사이즈.
	//////////////////////////////////////////////////////////////////////////
	int		PacketBuffer::Dequeue(char *chpSrc, int iSrcSize)
	{
		////////////////////////////////////////	예외처리....
